...
void print1() {
    ...
    for (auto const& company : companies) {
        ...
        std::cout << std::right << std::setw(5) << std::setfill(' ') << std::fixed << std::setprecision(1) << company.Growth
...
std::string to_roman(unsigned int value) {
    ...
    const static roman_t rarr[13] = {{1000, "M"}, {900, "CM"}, {500, "D"}, {400, "CD"}, {100, "C"}, {90, "XC"}, {50, "L"}, {40, "XL"},
...
void execute() {
    ...
    {
        std::cout << std::right << std::setfill('.') << std::setw(10) << "right" << std::endl; // .....right
    }

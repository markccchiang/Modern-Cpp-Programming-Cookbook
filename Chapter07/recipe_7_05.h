...
void test_money() {
...
#ifdef _WIN32
        "English_US.1252"s, "English_UK.1252"s, "Japanese_Japan.932"s, "French_France.1252"s, "German_Germany.1252"s,
        "Romanian_Romania.1250"s
#else
        "en_US.utf8"s, "en_GB.utf8"s, "ja_JP.utf8"s, "fr_FR.utf8"s, "de_DE.utf8"s, "ro_RO.utf8"s
#endif
    };
    ...
    for (auto const& locale : locale_names) {
        ...
        std::cout << std::showbase << locale << ": " << std::put_money(mon) << " or " << std::put_money(mon, true) << std::endl;
    }
